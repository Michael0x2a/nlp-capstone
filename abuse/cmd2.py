...
DataSoft = Tuple[List[str], List[float]]

def get_wikipedia_data_soft(category: str = None,
                            attribute: str = None,
                            use_dev: bool = True,
                            use_small: bool = False) -> Tuple[DataSoft, DataSoft]:
    '''
...
def main() -> None:
    ...
    datasets = {
            'wikipedia': get_wikipedia_data_soft,
    }
